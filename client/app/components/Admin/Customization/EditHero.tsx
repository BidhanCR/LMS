  ...
  return (
    <>
      <div className="w-full 1000px:flex items-center">
        <div className="absolute top-[180px] 1000px:top-[unset] 1500px:h-[700px] 1500px:w-[700px] 1100px:h-[500px] 1100px:w-[500px]">
          ...
          <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]">
            ...
            <textarea
              ...
              placeholder="We have 40+ Online courses and 500K+ online registered student. Find your desired Courses from them."
